...
static tBleStatus Configure_Profile(void)
{
  ...
  ret = aci_gap_init_IDB05A1(GAP_PERIPHERAL_ROLE, 0, 0x07,&gBLEProfileContext.gapServiceHandle, &gBLEProfileContext.devNameCharHandle, &gBLEProfileContext.appearanceCharHandle);
  if(ret!=BLE_STATUS_SUCCESS)
    goto INIT_PROFILE_FAIL;
...
uint8_t DBG_BlueNRG_evt[100];
uint8_t DBG_BlueNRG_evt_index = 0;
...
{  
  ...
  DBG_BlueNRG_evt[DBG_BlueNRG_evt_index++] = event_pckt->evt;
  DBG_BlueNRG_evt_index %= 100;
      ...
      case EVT_LE_CONN_COMPLETE:
        {
          ...
          if(gMainProfileCtxt.bleProfileMainState == BLE_PROFILE_STATE_CONNECTABLE) 
          {
            ...
            {
              memcpy(bdaddr,cc->peer_bdaddr, sizeof(bdaddr));
  ...
  case EVT_VENDOR:
    {
      ...
      case EVT_BLUE_GAP_PAIRING_CMPLT:
        {
              ...
              (gMainProfileCtxt.bleProfileMainState == BLE_PROFILE_STATE_CONNECTED) )
          {
            ...
            {
              char msg[50];
              sprintf(msg,"BlueNRG paired with device:\n%02X:%02X:%02X:%02X:%02X:%02X",
                bdaddr[0],
                bdaddr[1],
                bdaddr[2],
                bdaddr[3],
      ...
      Menu_MsgStatus("HID connected","Touch the screen to control a pointer on the smartphone.\nPush the user button to click.",MSG_INFO_SUCCESS);
      ...
      case EVT_BLUE_ATT_READ_BY_GROUP_TYPE_RESP:
        ...
        break;
        /*
      case EVT_BLUE_ATT_WRITE_RESP:
        {
          PROFILE_MESG_DBG ( profiledbgfile, "EVT_BLUE_ATT_WRITE_RESP \n");
        }
        break;
        */
      ...
      case EVT_BLUE_GAP_PROCEDURE_COMPLETE:
        ...
        /*  evt_gap_procedure_complete* evt = (evt_gap_procedure_complete*) blue_evt->data; */
          PROFILE_MESG_DBG ( profiledbgfile, "EVT_BLUE_GAP_PROCEDURE_COMPLETE \n");
         }
        break;
