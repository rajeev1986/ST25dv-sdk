/**
  ******************************************************************************
  * @file    st25dx_discovery_nfctag.c
  * @ingroup ST25DX_DISCOVERY_NFCTAG
...
/** @addtogroup BSP Board Support Package
  * @brief    Container module for the BSP modules.
  * @details  The Board Support Package software (BSP) is defined by the Cube methodology as the abstraction
  *           layer for the board specific features.\n
...
/** @defgroup ST25DX_DISCOVERY_NFCTAG ST25DX Discovery NFCTAG Board Support Package
  * @brief    This module provides high-level functions to access the ST25DV NFC dynamic tag.
  * @details  These functions are designed to be called by the Application or by a Middleware.
  * @{
  */
/* Private typedef -----------------------------------------------------------*/
/* Private defines -----------------------------------------------------------*/
